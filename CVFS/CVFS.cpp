...
void DisplayHelp()
{
     ...
     printf("fsat: To Display information of file using  file descriptor\n");
...
int rm_File(char * name)
{
     ...
     if(UFDTArr[fd].ptrfiletable->ptrinode->LinkCount==0)
     {
          ...
          //freeUFDTArr[fd].ptrfiletable->ptrinode->FileType = 0;
...
{
     char *ptr = NULL;
     int ret = 0;int fd = 0;int count = 0;
     ...
     while(1)
     {
          ...
          if(count == 1)
          {
               ...
               {
                    printf("Terminating the Marvellous Virtua File System\n");
                    break;
               }
               else
               {
          ...
          else if(count == 2)
          {
               ...
               else if(strcmp(command[0],"truncate")==0)
               {
                    ...
                    if(ret == -1)
                         printf("ERROR: Incorrect paramerter\n");
               }
               else
               {
                    printf("\nERROR: Command not found!!!!\n");
          ...
          else if(count == 3)
          {
               ...
               else if(strcmp(command[0],"read")==0)
               {
                    ...
                    if(ret == -4)
                         printf("ERROR: Its is not regualr file\n");
                    if(ret == 0)
